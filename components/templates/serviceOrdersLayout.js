...
export default function ServiceOrdersLayout({ orderList, scheduled }){
    ...
    <div className="service_order_component">
        ...
        <header className="header">
            <div className="flex_row flex_right">
                <div className="_100">
                    <HeaderMain title='Service Orders' buttonName="New Order" actionButton={() => setModalDx(true)}/>
                </div>
            </div>
        ...
        { modalDx && <ModalDXLayout close={() => setModalDx(false)}/> }
